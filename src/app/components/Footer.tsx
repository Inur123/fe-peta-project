...
"use client"; // Tambahkan directive ini jika diperlukan
...
const Footer = () => {
  return (
    <>
      ...
      {/* Footer Copyright */}
      <footer className="bg-black pt-10 pb-5">
        <div className="flex items-center">
          <div className="border-t border-4 border-[#be2c13] flex-grow"></div>
          <div className="px-3 text-white text-l">
            <span> © </span>
            <span>{new Date().getFullYear()}</span>
            <span> Peta Project | All Rights Reserved.</span>
          </div>
          <div className="border-t border-4 border-[#be2c13] flex-grow"></div>
        </div>
      </footer>
